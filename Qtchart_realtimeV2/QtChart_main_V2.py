...
class MainWindow(QMainWindow):
	...
	def setupWidget(self):
		...
		start_timeMS = QTime(0,0,0).msecsTo(QTime.currentTime())/1000
	...
	def lecturaData(self):
		...
		current_timeMS = QTime(0,0,0).msecsTo(QTime.currentTime())
		self.timeTESTE = current_timeMS/1000
	...
	def update_plot_data(self,ah1,ah2,ah3,ah4 ):
		...
		self.axisX.setRange(self.timeTESTE-60, self.timeTESTE) 
		# 60 = self.ndata * (sampler time in seconds)
		# axisX is in today's seconds
